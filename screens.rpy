...
screen friendship_bar():
    frame:
        xalign 0.02
        yalign 0.02
        has vbox
        text "Ashleigh Friendship: [ashleigh_friendship_level]" size 20
        bar value VariableValue("ashleigh_friendship_level", 0, 100) xsize 250 ysize 16
        text "Luke Friendship: [luke_friendship_level]" size 20
        bar value VariableValue("luke_friendship_level", 0, 100) xsize 250 ysize 16
